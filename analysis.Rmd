...
```{r, fig.cap="Distributions of difference in locations of lifestyle indicators in 2007 and 2018 in first and second axis and in the two-dimensional plane", out.width="100%"}
...
```{r}
new_whole <- find_most_important_categories_for_clusters(clust_2018_whole, n = 10, sign = "+", vuosi = "2007")
new_whole
```
